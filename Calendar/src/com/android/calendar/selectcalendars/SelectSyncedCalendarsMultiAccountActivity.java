...
public class SelectSyncedCalendarsMultiAccountActivity extends ExpandableListFragmentActivity implements
	...
	private static final String[] PROJECTION = new String[] { Calendars._ID, Calendars.ACCOUNT_TYPE,
	...
	protected void onResume() {
		...
		new AsyncQueryHandler(getContentResolver()) {
			...
			protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
				...
				mAdapter = new SelectSyncedCalendarsMultiAccountAdapter(findViewById(R.id.calendars).getContext(),
						mAccountsCursor, SelectSyncedCalendarsMultiAccountActivity.this);
		...
		}.startQuery(0, null, Calendars.CONTENT_URI, PROJECTION, "1) GROUP BY (" + ACCOUNT_UNIQUE_KEY, // Cheap
																										// hack
																										// to
																										// make
																										// WHERE
