...
import com.android.calendar.CalendarColorPickerDialogStock;
...
public class SelectCalendarsSyncAdapter extends BaseAdapter implements ListAdapter, AdapterView.OnItemClickListener,
	...
	private CalendarColorPickerDialogStock mColorPickerDialog;
	...
	public SelectCalendarsSyncAdapter(Context context, Cursor c, FragmentManager manager) {
		...
		mColorPickerDialog = (CalendarColorPickerDialogStock) manager.findFragmentByTag(COLOR_PICKER_DIALOG_TAG);
		mColorViewTouchAreaIncrease = context.getResources().getDimensionPixelSize(
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		colorView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// Purely for sanity check--view should be disabled if account
				// has no more colors
				...
				if (mColorPickerDialog == null) {
					mColorPickerDialog = CalendarColorPickerDialogStock.newInstance(mData[position].id, mIsTablet);
				} else {
