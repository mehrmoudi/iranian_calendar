...
public class ExtensionsFactory {
	...
	public static AnalyticsLogger getAnalyticsLogger(Application application) {
		...
		if (sAnalyticsLogger == null) {
			sAnalyticsLogger = new AnalyticsLogger() {
				...
				public void trackView(String name) {
					Tracker t = ((CalendarApplication) application).getTracker();
		...
		sAnalyticsLogger.initialize(application);
		return sAnalyticsLogger;
	}
}
