...
import com.android.timezonepickerstock.TimeZoneInfo;
import com.android.timezonepickerstock.TimeZonePickerDialog;
import com.android.timezonepickerstock.TimeZonePickerDialog.OnTimeZoneSetListener;
import com.android.timezonepickerstock.TimeZonePickerUtils;
...
public class GeneralPreferences extends PreferenceFragment implements OnSharedPreferenceChangeListener,
	...
	public static final String WEEK_START_DEFAULT = "7";
	...
	public void onCreate(Bundle icicle) {
		...
		// mWeekStart = (ListPreference)
		// preferenceScreen.findPreference(KEY_WEEK_START_DAY);
		...
		TimeZonePickerDialog tzpd = (TimeZonePickerDialog) activity.getFragmentManager().findFragmentByTag(
	...
	public void onTimeZoneSet(TimeZoneInfo tzi) {
		...
		final CharSequence timezoneName = mTzPickerUtils.getGmtDisplayName(getActivity(), tzi.mTzId,
				System.currentTimeMillis(), false);
