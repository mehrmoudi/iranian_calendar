...
public class SearchActivity extends FragmentActivity implements CalendarController.EventHandler,
	...
	protected void onCreate(Bundle icicle) {
		...
		if (mIsMultipane) {
			...
			getActionBar().setDisplayOptions(0, ActionBar.DISPLAY_HOME_AS_UP | ActionBar.DISPLAY_SHOW_HOME);
		}
	...
	private void showEventInfo(EventInfo event) {
		if (mShowEventDetailsWithAgenda) {
			...
			mEventInfoFragment = new EventInfoFragment(this, event.id, event.startTime.toMillis(false),
					event.endTime.toMillis(false), event.getResponse(), false, EventInfoFragment.DIALOG_WINDOW_STYLE,
	...
	protected void onResume() {
		...
		Utils.setMidnightUpdater(mHandler, mTimeChangesUpdater, Utils.getTimeZone(this, mTimeChangesUpdater));
