...
import com.android.colorpickerstock.ColorPickerDialog;
import com.android.colorpickerstock.ColorPickerSwatch.OnColorSelectedListener;
import com.android.colorpickerstock.HsvColorComparator;
import com.congenialmobile.calendar.R;

public class CalendarColorPickerDialogStock extends ColorPickerDialog {
	...
	static final String[] CALENDARS_PROJECTION = new String[] { Calendars.ACCOUNT_NAME, Calendars.ACCOUNT_TYPE,
	...
	static final String[] COLORS_PROJECTION = new String[] { Colors.COLOR, Colors.COLOR_KEY };

	static final String COLORS_WHERE = Colors.ACCOUNT_NAME + "=? AND " + Colors.ACCOUNT_TYPE + "=? AND "
	...
	private class QueryService extends AsyncQueryService {
		...
		protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
			...
			case TOKEN_QUERY_CALENDARS:
				...
				String[] args = new String[] { cursor.getString(CALENDARS_INDEX_ACCOUNT_NAME),
	...
	private class OnCalendarColorSelectedListener implements OnColorSelectedListener {
		...
		public void onColorSelected(int color) {
			...
			mService.startUpdate(mService.getNextToken(), null,
					ContentUris.withAppendedId(Calendars.CONTENT_URI, mCalendarId), values, null, null,
					Utils.UNDO_DELAY);
		}
	}

	public CalendarColorPickerDialogStock() {
		// Empty constructor required for dialog fragments.
	}

	public static CalendarColorPickerDialogStock newInstance(long calendarId, boolean isTablet) {
		CalendarColorPickerDialogStock ret = new CalendarColorPickerDialogStock();
		ret.setArguments(R.string.calendar_color_picker_dialog_title, NUM_COLUMNS, isTablet ? SIZE_LARGE : SIZE_SMALL);
	...
	private void startQuery() {
		if (mService != null) {
			...
			mService.startQuery(TOKEN_QUERY_CALENDARS, null,
					ContentUris.withAppendedId(Calendars.CONTENT_URI, mCalendarId), CALENDARS_PROJECTION, null, null,
					null);
		}
	}
}
