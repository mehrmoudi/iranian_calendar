...
public class ColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = LayoutInflater.from(getActivity()).inflate(R.layout.color_picker_dialog_stock, null);
		...
		mAlertDialog = new AlertDialog.Builder(activity).setTitle(mTitleResId).setView(view).create();
	...
	public void onColorSelected(int color) {
		...
		if (color != mSelectedColor) {
			...
			// Redraw palette to show checkmark on newly selected color before
			// dismissing.
