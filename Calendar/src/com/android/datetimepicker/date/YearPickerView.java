...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
	...
	private void init(Context context) {
		...
		for (int year = mController.getMinYear(); year <= mController.getMaxYear(); year++) {
			years.add(Jalali.persianDigits(String.format("%d", year)));
		}
	...
	private class YearAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Time time = new Time();
            time.set(mController.getSelectedDay().day, mController.getSelectedDay().month, mController.getSelectedDay().year);
            JalaliDate jDate = Jalali.gregorianToJalali(time);
            boolean selected = jDate.year == year;
	...
	public void onDateChanged() {
        ...
        time.set(mController.getSelectedDay().day, mController.getSelectedDay().month, mController.getSelectedDay().year);
        JalaliDate jDate = Jalali.gregorianToJalali(time);
		postSetSelectionCentered(jDate.year - mController.getMinYear());
	}
