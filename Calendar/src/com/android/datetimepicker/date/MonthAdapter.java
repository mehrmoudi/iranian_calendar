...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
	...
	private JalaliDate mSelectedJalaliDay;
	...
	public void setSelectedDay(CalendarDay day) {
		Time time = new Time();
		time.set(day.getDay(), day.getMonth(), day.getYear());
		mSelectedJalaliDay = Jalali.gregorianToJalali(time);
		notifyDataSetChanged();
	}

	public JalaliDate getSelectedJalaliDay() {
		return mSelectedJalaliDay;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (isSelectedDayInMonth(year, month)) {
			selectedDay = mSelectedJalaliDay.day;
		}
	...
	private boolean isSelectedDayInMonth(int year, int month) {
		return mSelectedJalaliDay.year == year && mSelectedJalaliDay.month == month + 1;
	}
