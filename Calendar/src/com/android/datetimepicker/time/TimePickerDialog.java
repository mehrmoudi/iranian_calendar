...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    private void setHour(int value, boolean announce) {
        ...
        mHourView.setText(Jalali.persianDigits(text.toString()));
        mHourSpaceView.setText(Jalali.persianDigits(text.toString()));
        if (announce) {
    ...
    private void setMinute(int value) {
        ...
        Utils.tryAccessibilityAnnounce(mTimePicker, text);
        mMinuteView.setText(Jalali.persianDigits(text.toString()));
        mMinuteSpaceView.setText(Jalali.persianDigits(text.toString()));
    }
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            mHourView.setText(Jalali.persianDigits(hourStr.toString()));
            mHourSpaceView.setText(Jalali.persianDigits(hourStr.toString()));
            mHourView.setTextColor(mUnselectedColor);
            mMinuteView.setText(Jalali.persianDigits(minuteStr.toString()));
            mMinuteSpaceView.setText(Jalali.persianDigits(minuteStr.toString()));
