...
/**
 * Implements special address cleanup rules: The first space key entry following
 * an "@" symbol that is followed by any combination of letters and symbols,
 * including one+ dots and zero commas, should insert an extra comma (followed
 * by the space).
 *
 * @hide
 */
